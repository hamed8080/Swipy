...
Thank you for considering contributing to Swipy.

Please know that everyone is welcome to contribute to Swipy.
...
Swipy is an open source project and we encourage contributions
from the community.

### Contributing Code and Documentation

Before contributing code or documentation to Swipy,
we encourage you to first open a 
[GitHub issue](https://github.com/hamed8080/Swipy/issues/new/choose) 
...
All changes to Swipy source must go through the PR review process before
...
Swipy is a Swift package. If you're new to Swift package manager,
...
1. Checkout this repository using:
    ...
    ```bash
    git clone git@github.com:hamed8080/Swipy.git
    ```
...
4. Build Swipy from the command line by running:
